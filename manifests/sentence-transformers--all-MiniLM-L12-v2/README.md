...
# ONNX build of sentence-transformers/all-MiniLM-L12-v2
...
| Variant | File | Size |
|---|---|---|
| int8 | `onnx/model_quantized.onnx` | 32 MB |
| q4f16 | `onnx/model_q4f16.onnx` | 33 MB |
...
[sentence-transformers/all-MiniLM-L12-v2](https://huggingface.co/sentence-transformers/all-MiniLM-L12-v2) before use.
