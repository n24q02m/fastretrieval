...
from fastretrieval.common.model_description import ModelSource, SparseModelDescription
...
class SpladePP(SparseTextEmbeddingBase, OnnxTextModel[SparseEmbedding]):
    def _post_process_onnx_output(
        ...
        # ⚡ Bolt: Fast masking and in-place operations for SPLADE reduction (~2x faster memory and time efficiency)
